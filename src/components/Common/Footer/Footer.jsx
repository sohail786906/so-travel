      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Hyderabd, Telangana India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:mohammedsohail.java@gmail.com" className="d-block" >mohammedsohail.java@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:8688230169" className="d-block" >8688230169</a>
          </div>
        ...
        <p className="text-light">   @ 2024. Mohammed Sohail All rights reserved </p> 
        </Col>
        </Row>
